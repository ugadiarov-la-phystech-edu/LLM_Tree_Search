...
config = {
    ...
    "train": {
        ...
        "checkpoint_dir": "LLM_Tree_Search_RLHF",
        "save_optimizer": False,
        "tracker": "wandb",
        "entity_name": "ula_elfray",
        "group_name": "rlhf_critic",
        "tags": ["rlhf_critic"],
        "logging_dir": "logs/",
        "project_name": "LLM_Tree_Search_RLHF",
        "pre_onpolicy_datapath": "../../tsllm/offline_rl/rlhf/rlhf/processed/rlhf_data.jsonl",
